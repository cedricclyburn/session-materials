...
func labels(v *demov1alpha1.DemoSite, tier string) map[string]string {
...
func (r *ReconcileDemoSite) ensureDeployment(request reconcile.Request,
	instance *demov1alpha1.DemoSite,
	name string,
...
func (r *ReconcileDemoSite) ensureService(request reconcile.Request,
	instance *demov1alpha1.DemoSite,
	name string,
	s *corev1.Service,
) (*reconcile.Result, error) {
